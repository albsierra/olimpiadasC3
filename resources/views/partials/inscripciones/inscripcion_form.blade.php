<form method="post" action="{{ route('inscripcion') }}" id="formulario">
    ...
    <div class="row gtr-uniform">
        <div class="col-12"><input type="checkbox" name="terminos" id="terminos" required><label for="terminos">Hemos leído y aceptado las bases</label>
            <ul>
                <li><a href="{{ asset(Storage::url('ediciones/edicion' . \App\Models\Edicion::getEdicionActual()->id . '/basesOlimpiada.pdf')) }}" download >Bases de la Olimpiada Informática</a></li>
                <li><a href="{{ asset(Storage::url('ediciones/edicion' . \App\Models\Edicion::getEdicionActual()->id . '/basesModding.pdf')) }}" download >Bases del Modding Regional</a></li>
                <li><a href="{{ asset(Storage::url('ediciones/edicion' . \App\Models\Edicion::getEdicionActual()->id . '/basesC3Gamer.pdf')) }}" download >Bases del C3Gamer</a></li>
            </ul>
        </div>
